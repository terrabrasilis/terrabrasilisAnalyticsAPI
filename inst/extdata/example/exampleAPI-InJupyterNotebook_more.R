...
# # save result
# saveRDS(allM, file = "/home/adeline/github_projects/tbAnalyticsAPI_examples/allMunicipalities.Rds")
# open file
allM <- readRDS(file = "/home/adeline/github_projects/tbAnalyticsAPI_examples/allMunicipalities.Rds")
...
write.table(allM_names, file = "/home/adeline/github_projects/tbAnalyticsAPI_examples/allMunicipalities.csv", 
